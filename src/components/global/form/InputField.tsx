  ...
  return (
    <div className={cn('mb-5 w-full relative', containerClassName)}>
      <Input
        ...
        disabled={disabled}
        className={cn(`px-4 w-full py-1 h-12 font-light  border-black text-normal focus-visible:border-[3px] focus-visible:border-asc-[#79747E] rounded-md invalid:focus:border-asc-black invalid:focus:border-4 invalid:focus:border-solid invalid:border-asc-error ${error ? 'border-asc-error' : ''}`, className)}
      />
      <label htmlFor={name}>
